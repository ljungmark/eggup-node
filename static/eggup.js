...
Eggup.prototype.synchronize = function() {
  ...
  console.log('%c 2016-2013 Ljungmark, CC BY-NC-SA 4.0 ', [,
      ...
      'sv' : {
        'egg': {
          'bubble': {
            ...
            '96': '"Det är lite som att passera den Nordkoreanska gränsen, att passera igenom QA" -Frisk',
            ...
            '179': '"Alltså, dem vill någon riktigt korkat..." -Qvarford',
          }
        },
        'map': {
          '1': 'Beställ ägg',
